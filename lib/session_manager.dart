...
class SessionManager extends BaseComponent {
  SessionManager({required this.game, required Vector2 size}) {
    TextPaint regular =
        TextPaint(config: TextPaintConfig(color: Color.fromARGB(255, 0, 0, 0)));
    ...
    healthLeftComponent =
        TextComponent('health: $_healthLeft', textRenderer: regular)
          ..anchor = Anchor.topCenter
        ...
        renderer: (canvas, particle) {
          ...
          canvas.drawRect(
            ...
            Paint()
              ...
              ..shader =
                  RadialGradient(colors: [Colors.transparent, Colors.red])
